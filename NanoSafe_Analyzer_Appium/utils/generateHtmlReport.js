 ...
 * Generates android-execution-report.html under reports/latest/.
 */
...
const outputFilePath = path.join(__dirname, '../../reports/latest/android-execution-report.html');

function generateMobileHtmlReport() {
    console.log("Generating Mobile E2E HTML Report...");

    let testResults = [];
    if (fs.existsSync(stateFilePath)) {
        testResults = JSON.parse(fs.readFileSync(stateFilePath, 'utf8'));
    } else {
        // Fallback mock/minimal results
        testResults = [
            {
                id: 'MOB_AUTH_01',
...
<head>
    ...
    <title>NanoSafe Mobile App E2E Test Report</title>
    <style>
        :root {
            --primary: #0f766e;
...
<body>
    ...
    <div class="header">
        <div>
            <h1>📱 NanoSafe Mobile</h1>
            <p>Appium / WebdriverIO E2E Mobile Verification Suite</p>
        </div>
        <div style="text-align: right;">
            <p style="font-weight: 700;">Build ID: #MOBILE_LATEST</p>
    ...
    <div class="container">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                <span class="label">Total Mobile Cases</span>
        ...
        <div class="dashboard-grid">
            ...
            <div style="display: flex; flex-direction: column; gap: 20px;">
                <div class="card">
                    ...
                    <div class="env-info">
                        <div><span>Host OS</span><strong>Android Emulator</strong></div>
                        <div><span>App Package</span><strong>com.nanosafe.mobile</strong></div>
                        <div><span>Test runner</span><strong>WebdriverIO v8</strong></div>
                        <div><span>Appium server</span><strong>v2.0</strong></div>
                    </div>
                </div>
            ...
            <div class="card">
                <h2>📜 Detailed Mobile Execution Trace</h2>
    ...
    console.log(`Mobile HTML report successfully saved to: ${outputFilePath}`);
}
